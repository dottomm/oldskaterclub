...
CREATE TABLE  `oldskaterclub`.`users` (
  ...
  `activationKey` int(11) DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `oldskaterclub`.`users` VALUES  (1,'1','Tomas','Tranfaglia','311 Woodside Drive','Rohnert Park','CA','USA','usertom','queenie','tom@dottomm.com',NULL,'2013-12-27 11:08:03','2013-12-27 11:08:03','2013-12-27 11:08:15','50.202.194.198','free','0000-00-00','50.202.194.198',0,'0000-00-00',0,'',0,'0.00',NULL),
 (2,'0','Skater','Hater','211 Board Street','Petaluma','CA','USA','skaterhater','queenie','skater@hater.com',NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00','0000-00-00 00:00:00','','free','0000-00-00','',0,'0000-00-00',0,'',0,'0.00',NULL);
UNLOCK TABLES;
